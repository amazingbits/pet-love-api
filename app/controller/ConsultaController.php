...
class ConsultaController extends DefaultController
{
    ...
    public function all($data)
    {
        ...
        $this->response($this->consultaDAO->selectAll($orderColumn, $orderDirection, $limit, $offset, $justActive));
    }

    public function getById($data)
    {
        $id = (int)$data["id"];
        $this->response($this->consultaDAO->selectById($id));
    }
    ...
    public function save()
    {
        ...
        if($this->consultaDAO->insert($params)) {
            $this->response([
    ...
    public function update($data = [])
    {
        ...
        if($this->consultaDAO->update($params, ["id" => $id])) {
            $this->response([
    ...
    public function delete($data = [])
    {
        ...
        if (!$this->consultaDAO->compare(["id" => $id])) {
            $this->response([
                "message" => "Não existe registro com este ID"
            ], HTTP_NOT_FOUND);
        }

        if ($this->consultaDAO->delete($id)) {
            $this->response([
    ...
    public function changeVisibility($data = [])
    {
        ...
        if ($this->consultaDAO->disable($id, $visibility)) {
            $this->response([
